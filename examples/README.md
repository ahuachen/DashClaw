...
`managed-agent-mcp/` — The simplest way to govern a Claude Managed Agent. Uses DashClaw's MCP server — one config line gives the agent 8 governance tools and 4 resources. ~120 lines.
