    ...
    <div className="mb-6 rounded-xl border border-[rgba(255,255,255,0.07)] bg-surface-secondary px-4 py-3">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-semibold uppercase tracking-wider text-zinc-300">Operator Lens</div>
            <div className="text-xs text-zinc-500">Apply the same signal filter to both the decision timeline and live mission feed.</div>
          </div>
        </div>
