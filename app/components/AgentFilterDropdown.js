  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="cursor-pointer appearance-none rounded-lg border border-border bg-surface-tertiary px-2.5 py-1.5 pr-7 text-sm text-zinc-300 transition-colors duration-150 hover:border-border-hover focus:border-brand/50 focus:outline-none focus:ring-2 focus:ring-brand/20"
