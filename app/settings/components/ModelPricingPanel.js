...
const DEFAULT_PRICING = [
  { pattern: 'opus', label: 'Claude Opus 4', input: 15, output: 75 },
  { pattern: 'sonnet', label: 'Claude Sonnet 4', input: 3, output: 15 },
  { pattern: 'haiku', label: 'Claude Haiku 4', input: 0.80, output: 4 },
  ...
  { pattern: 'codex', label: 'Codex (OpenAI)', input: 3, output: 15 },
  { pattern: 'o3', label: 'OpenAI o3', input: 2, output: 8 },
  { pattern: 'o4-mini', label: 'OpenAI o4-mini', input: 1.10, output: 4.40 },
