const PROVIDER_REGISTRY = Object.freeze({
  ...
  anthropic: {
    ...
    defaults: {
      ...
      predictive_risk: 'claude-3-5-haiku-latest',
    },
    models: [
      ...
      { id: 'claude-opus-4-1-20250805', label: 'Claude Opus 4.1', status: 'active', capabilities: ['chat', 'reasoning'] },
      { id: 'claude-sonnet-4-20250514', label: 'Claude Sonnet 4', status: 'active', capabilities: ['chat'] },
      { id: 'claude-opus-4-20250514', label: 'Claude Opus 4', status: 'active', capabilities: ['chat', 'reasoning'] },
      { id: 'claude-3-7-sonnet-latest', label: 'Claude Sonnet 3.7', status: 'active', capabilities: ['chat'] },
      { id: 'claude-3-5-haiku-latest', label: 'Claude Haiku 3.5', status: 'active', capabilities: ['chat', 'fast', 'cheap'] },
    ],
  },
  groq: {
    id: 'groq',
...
export function getProviderModelEntries(provider) {
...
export function getDefaultProviderModel(provider, useCase = null) {
