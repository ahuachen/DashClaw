...
export function shapeCollection(row) {
  if (!row) return null;
  return {
...
export async function listCollections(sql, orgId, filters = {}) {
...
export async function getCollection(sql, orgId, collectionId) {
...
export async function createCollection(sql, orgId, data) {
...
export async function listCollectionItems(sql, orgId, collectionId, filters = {}) {
...
export async function addCollectionItem(sql, orgId, collectionId, data) {
