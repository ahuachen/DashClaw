...
const stepsByAgent = [
  ...
  [
    ...
    },
    {
      ...
      metadata: JSON.stringify({ example: 'const dc = new DashClaw({ apiKey: process.env.DASHCLAW_API_KEY }); await dc.actions.record({ action_type: "deploy", declared_goal: "Ship v2.1" });' }),
      risk_score: 8,
      cost_estimate: 0.003,
      tokens_in: 400,
      tokens_out: 550,
  ...
  [
    ...
    },
    {
      ...
      output_summary: 'Import the SDK and create a client instance with your API key. The client is reusable — create it once at startup and pass it to your agent functions. It automatically detects the DashClaw endpoint from DASHCLAW_URL or defaults to localhost:3000.',
      reasoning: 'A single shared client instance avoids redundant connections and ensures consistent configuration.',
      metadata: JSON.stringify({ code: "import { DashClaw } from '@dashclaw/sdk';\nconst dc = new DashClaw({ apiKey: process.env.DASHCLAW_API_KEY });" }),
      risk_score: 12,
      cost_estimate: 0.003,
      tokens_in: 380,
      tokens_out: 460,
  ...
  [
    {
      ...
      metadata: JSON.stringify({ url: '/workspace', features: ['digest', 'context-threads', 'handoffs', 'snippets', 'preferences', 'memory'] }),
      risk_score: 20,
      cost_estimate: 0.005,
      tokens_in: 420,
      tokens_out: 560,
    ...
    },
    {
      ...
      metadata: JSON.stringify({ url: '/workspace#digest', auto_generated: true, includes: ['recent-actions', 'open-loops', 'assumptions', 'handoffs'] }),
      risk_score: 5,
      cost_estimate: 0.002,
      tokens_in: 300,
      tokens_out: 420,
