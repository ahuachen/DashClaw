    ...
    <div className="min-h-screen bg-surface-primary text-text-primary">
      ...
      <main className="pt-28 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <div className="mt-20 p-8 rounded-2xl bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-brand/20">
          ...
          <p className="text-text-secondary mb-6 max-w-xl">Copy the tools into your agent workspace and start capturing governed data in minutes.</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div>
              <p className="text-xs text-text-tertiary font-mono mb-2">Mac / Linux</p>
            ...
            <div>
              <p className="text-xs text-text-tertiary font-mono mb-2">Windows (PowerShell)</p>
              <div className="bg-surface-primary rounded-lg px-4 py-3 border border-border">
          ...
          <div className="mb-6">
            <p className="text-xs text-text-tertiary font-mono mb-2">Sync all local data to your DashClaw instance</p>
            <div className="bg-surface-primary rounded-lg px-4 py-3 border border-brand/10">
              <code className="text-xs text-brand font-mono">python sync_to_dashclaw.py</code>
              <span className="text-text-disabled text-xs font-mono ml-2"># or add --dry-run to preview</span>
            </div>
          </div>
