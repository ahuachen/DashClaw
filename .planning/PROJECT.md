...
- [ ] **Define a monetization trigger.** Not a price — a *trigger*. "When X happens, Pro tier goes live." Candidates: 500 WAU, 50 Claude Code integrations in the wild, 20 hrs/week of founder time, or first unsolicited "take my money" DM. **Pick one and commit, so "free first, paid later" doesn't become "free forever."**
...
| Monetization: free first, paid later — but with a trigger | "Later without a trigger becomes never." Trigger to be defined in REQUIREMENTS | ⚠️ Trigger pending |
